...
import { Checkbox, Field, HorizontalGroup, Icon, IconButton, Input, Select, CustomScrollbar, useTheme2, ToolbarButton, ButtonGroup, InlineField, InlineSwitch } from '@grafana/ui';
...
export const ModifyData: React.FC<Props> = ({ model, collections, deleteCollection, updateCollection, currentCollIdx, setCurrentCollIdx }) => {
    ...
    useEffect(() => {
        ...
        if (div) setDivHeight(context.height - div.offsetHeight - 20)
    ...
    return <div>
        ...
        <div style={{ width: '100%', backgroundColor: theme.colors.background.secondary, padding: '10px', marginBottom: '10px' }}>
            <p style={{ color: theme.colors.text.primary, paddingBottom: '0px', marginBottom: '2px' }}>{context.messages._panel._step3.currentCollection}</p>
        ...
        <div style={{ backgroundColor: theme.colors.background.secondary, padding: '10px', paddingBottom: '0px' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'flex-end' }}>
                <InlineField label={context.messages._panel._step3.showCategories} disabled={disabled}>
